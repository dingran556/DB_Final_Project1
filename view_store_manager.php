                    ...
                    <div class='span8'>
                        <table class="table striped hovered dataTable" id="dataTables-1">
                            ...
                            <tbody>    
                                ...
                                ?>
                                <td>
                                    <form name="editStoreManager" action="edit_store_manager.php" method="GET">
                                        <input type="hidden" name="store_manager_id" value="<?php echo $store_manager_id; ?>"/>
                                        <input type="submit" name="editStoreManager" value="Edit"/>
                                    </form>
                                </td>
                                <td>
                                    <form name="deleteStoreManager" action="delete_store_manager.php" method="POST">
                                        <input type="hidden" name="store_manager_id" value="<?php echo $store_manager_id; ?>"/>
                                        <input type="submit" name="deleteStoreManager" value="Delete"/>
                                    </form>
                                </td>
                                <?php
                                echo "</tr>\n";
