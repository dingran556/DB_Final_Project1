                   ...
                   <div class="span3">
                            ...
                            <ul>
                                ...
                                <li class="stick bg-cyan">
                                    ...
                                    <ul class="dropdown-menu" data-role="dropdown">
                                        ...
                                        <li class="divider"></li>
                                        <li class="active"><a href="customer_compare.php">Customer Comparison</a></li>
                                        <li class="divider"></li>
                    ...
                    <div class='span8'>
                        <table class="table striped" id="dataTables-1">
                            <legend>Customer Comparison</legend>
                            <thead>
                                <tr>
                                    <th class="text-left">name</th>
                                    <th class="text-left">Total Order Buying</th>
                                </tr>
                            </thead>
                            <tbody>    
                                <?php
                                    require_once("Includes/db.php");
                                    $result = db::getInstance()->get_cusotmer_comp();
