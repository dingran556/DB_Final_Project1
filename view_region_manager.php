                ...
                <div class='row'>
                    ...
                    <div class='span8'>
                        <table class="table striped hovered dataTable" id="dataTables-1">
                            <legend>Region Manager Info</legend>
                            <thead>
                                <tr>
                                    <th class="text-left">Region Manager Name</th>
                            ...
                            <tbody>    
                                <?php
                                    ...
                                    while($row = mysqli_fetch_array($result)):
                                        ...
                                        $region_manager_id = $row["EmployeeID"];
                                ?>
                                <td>
                                    <form name="editRegionManager" action="edit_region_manager.php" method="GET">
                                        <input type="hidden" name="region_manager_id" value="<?php echo $region_manager_id; ?>"/>
                                        <input type="submit" name="editRegionManager" value="Edit"/>
                                    </form>
                                </td>
                                <td>
                                    <form name="deleteRegionManager" action="delete_region_manager.php" method="POST">
                                        <input type="hidden" name="region_manager_id" value="<?php echo $region_manager_id; ?>"/>
                                        <input type="submit" name="deleteRegionManager" value="Delete"/>
                                    </form>
                                </td>
                                <?php
                                echo "</tr>\n";
                        ...
                        <form name="addRegionManager" action="edit_region_manager.php">
                            <fieldset>
                                <legend>Insert Region Manager</legend>    
