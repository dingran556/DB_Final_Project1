                ...
                <div class='row'>
                    ...
                    <div class='span8'>
                        <table class="table striped hovered dataTable" id="dataTables-1">
                            <legend>Business Customer Info</legend>
                            <thead>
                                <tr>
                            ...
                            <tbody>    
                                <?php
                                    ...
                                    $result = db::getInstance()->get_all_business_customer();
                                    while($row = mysqli_fetch_array($result)):
                                        echo "<tr><td>" . htmlentities($row["Name"]) . "</td>";
                                        echo "<td>" . htmlentities($row["Business_Category"]) . "</td>";
                                        echo "<td>" . htmlentities($row["GrossAnnualIncome"]) . "</td>";
                                ...
                                ?>
                                <td>
                                    <form name="editBusinessCustomer" action="edit_business_customer.php" method="GET">
                                        <input type="hidden" name="customer_id" value="<?php echo $customer_id; ?>"/>
                                        <input type="submit" name="editBusinessCustomer" value="Edit"/>
                                    </form>
                                </td>
                                <td>
                                    <form name="deleteBusinessCustomer" action="delete_business_customer.php" method="POST">
                                        <input type="hidden" name="customer_id" value="<?php echo $customer_id; ?>"/>
                                        <input type="submit" name="deleteBusinessCustomer" value="Delete"/>
                                    </form>
                                </td>
                                <?php
                                echo "</tr>\n";
                        ...
                        <form name="addBusinessCustomer" action="edit_business_customer.php">
                            <fieldset>
                                <legend>Insert Business Customer</legend>    
